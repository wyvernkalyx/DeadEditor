...
**Build/Test Baseline (2026-06-10):** `dotnet build DeadEditor/DeadEditor.csproj` (clean) -> 0 errors, 51 unique warnings (MSBuild reports 102; the WPF markup + main double-compile emits each warning under both the main and `_wpftmp` project): 25 CA1416 platform-compat + 22 CS8618 uninitialized-non-nullable + 4 other nullable CS86xx; `dotnet test DeadEditor.sln` -> 338 passed, 0 failed, 0 skipped
